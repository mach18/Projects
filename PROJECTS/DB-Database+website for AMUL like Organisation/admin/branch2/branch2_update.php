...
{
$result = mysql_query("select * from branch2 where uid=".$_POST['uid']);
      ...
      <div id="signup-form">
       ...
       <div id="signup-inner">
		...
		<!--	<p>Please complete the fields below, ensuring you use a valid email address as you will be sent a validation code which you will need the first time you login to the site.</p>-->
            ...
            <form id="send" action="branch2_insert.php" method="post" enctype="multipart/form-data">
            	
                <p>

                <label for="name">Uid </label>
                <input id="name" type="text" name="uid"  value="<? echo $row['uid'] ?>" />
                </p>

		<p>
                <label for="salary">item</label>
                <input id="name" type="text" name="item" value="<? echo $row['item'] ?>" />
                </p>
		<p>
...
<form id="send" action="branch2_update.php" method="post" enctype="multipart/form-data">
<p>
<label for="name">Uid</label>
