...
{
$result = mysql_query("select * from branch1 where uid=".$_POST['uid']);
      ...
      <div id="signup-form">
       ...
       <div id="signup-inner">
		...
		<!--	<p>Please complete the fields below, ensuring you use a valid email address as you will be sent a validation code which you will need the first time you login to the site.</p>-->
            ...
            <form id="send" action="branch1_insert.php" method="post" enctype="multipart/form-data">
		...
		<p>
                <label for="salary">Manager</label>
                <input id="name" type="text" name="manager" value="<? echo $row['manager'] ?>" />
                </p>
		<p>
		...
		<p>
               <label for="dept">Revenue</label>
                <input id="dept" type="int" name="revenue" value="<? echo $row['revenue'] ?>" />
                </p>
...
<form id="send" action="branch1_update.php" method="post" enctype="multipart/form-data">
<p>
<label for="name">Uid</label>
<input id="name" type="int" name="uid" />
</p>
